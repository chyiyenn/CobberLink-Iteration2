...
export function LayoutOne({ recipe, preventClick }) {
	return (
		<div
		...
		>
			<div className="dr-post-summary layout-1">
				<div className="dr-recipe-summary-inner">
					<div className="dr-recipe-summary-header">
							...
							{recipe.recipe_badges && (
								<span className="dr-badge">
									<a
										...
										dangerouslySetInnerHTML={{
											__html: recipe.recipe_badges.badge,
										}}
									></a>
								</span>
							)}
					...
					<div className="dr-recipe-summary-header-bottom dr-title-wrap">
						...
						<div className="dr-recipe-summary-button-wrap">
							<div
